...
{\href{https://github.com/DesktopDefender/DesktopDefender}{Desktop Defender \footnotesize{\faGithub}}}
  ...
  % {}
\resumeItemListStart
\item Envisioned \& developed a cross-platform desktop application in Tauri for users to monitor their home network
\item found router's IP on LAN, scraped unauthorized endpoints on admin portal to brute force known admin credentials
\resumeItemListEnd
...
{\href{https://github.com/lsig/raft}{Raft \footnotesize{\faGithub}}}
	...
	% {}
\resumeItemListStart
\item Developed \href{https://raft.github.io/}{Raft Consensus algorithm} from scratch in Golang over gRPC, using concurrent nodes in distributed network
