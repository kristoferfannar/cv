...
\section{\textbf{Technical Skills}}
 ...
 \resumeSubItem{Languages \& frameworks| }
    {Python $\cdot$ Typescript $\cdot$ Go $\cdot$ Rust $\cdot$ Java $\cdot$ C / C++ $\cdot$  React $\cdot$ Nextjs $\cdot$ SQL $\cdot$ Bash $\cdot$ Scikit-learn}
	...
	{Distributed Systems $\cdot$ Cybersecurity $\cdot$ Linux Kernel $\cdot$ Competitive Programming $\cdot$ Data Structures \& Algorithms $\cdot$ CTFs}
