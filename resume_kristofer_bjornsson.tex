...
\resumeProject
	...
	{April 2024}
	{\socialicon{\faGithub} \href{https://github.com/lsig/raft}{repo}}
\resumeItemListStart
	\item Developed the \href{https://raft.github.io/}{Raft Consensus algorithm} from scratch in Golang
	\item Verified consistent logs between tens of servers bouncing over $100.000$ concurrent messages on a LAN
\resumeItemListEnd
