...
\resumeProject
  ...
  {Jul 2023 -}
\resumeItemListStart
\item Launched full-stack mobile app on \href{https://apps.apple.com/is/app/premking/id6476774713}{the App Store} with $\approx$ 100 monthly users using React Native \& Go backend on AWS, connected to PostgresSQL database 
	
\item Utilized cronjobs to fetch data from API, updating user scores \& calculating positions on new responses
