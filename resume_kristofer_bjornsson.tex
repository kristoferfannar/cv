...
\section{\textbf{Professional Experience}}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
		\item Built security desktop app for macOS, utilizing privileged macOS API access for receiving and signing user input in Rust
  ...
  \resumeSubheading
	...
	\item Supported multi-user multi-role functionality with in-house authentication service using JWT tokens 
...
\resumeItemListStart
	...
	\item Developed an open source full-stack multi-user mobile app with React Native, hosting Go backend on AWS EC2, connecting to PostgresSQL database on Supabase, supporting user sessions through Google OAuth
...
\item Rewrote Keystrike's core cryptographic attestation protocol in Python \& Golang with ECDSA signatures
