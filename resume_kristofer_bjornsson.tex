...
\section{\textbf{Professional Experience}}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
		\item Ported main offering, a security desktop driver, to macOS in Rust, now adopted by 1/3rd of company's customer base

		% \item Setup platform agnostic library APIs using Rust traits in Windows coupled codebase
...
\resumeItemListStart
	...
	\item Developed an open source full-stack mobile app with React Native, hosting Go backend on AWS EC2, connecting to PostgresSQL database on Supabase, supporting user sessions through Google OAuth
	
	\item Utilized cronjobs to fetch data from external API, concurrently updating user scores on new responses

	\item Launched app on Apple Testflight, hosting successful beta with tens of users
...
\item Determined whether a sequence of typed inputs could produce an edited string as a form of continuous authentication
