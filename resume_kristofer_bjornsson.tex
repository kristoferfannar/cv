...
\newcommand{\baseSpace}{7.4}

\makeatletter
\newcommand\fontHeaderInfo{%
  \@setfontsize\fontHeaderInfo{9.5pt}{11.0pt} % font size, baseline skip
}
\makeatother

\makeatletter
\newcommand\fontSection{%
  \@setfontsize\fontSection{13.0pt}{14.0pt} % font size, baseline skip
}
\makeatother

\makeatletter
\newcommand\fontTitle{%
  \@setfontsize\fontTitle{11.5pt}{14.0pt} % font size, baseline skip
}
\makeatother

\makeatletter
\newcommand\fontText{%
  \@setfontsize\fontText{11.0pt}{12.5pt} % font size, baseline skip
}
\makeatother

\titleformat{\section}
{\vspace{\fpeval{1.5 * \baseSpace}pt}\scshape\raggedright\fontSection}
  {}{0em}
  {\sectiontitlerule}
  []
...
\newcommand{\resumeItem}[2]{
  \item{
	\fontText{\textbf{#1}{\hspace{0.5mm}#2 \vspace{\fpeval{0 * \baseSpace} pt}}}
  }
}
...
\newcommand{\resumeSubheading}[4]{
    ...
    \begin{tabular*}{0.99\textwidth}[t]{l@{\extracolsep{\fill}}r}
		\textbf{\fontTitle{#1}} & \fontText{#4} \\
        \fontText{#3} &  \fontText{#2}\\
    \end{tabular*}
...
\newcommand{\resumeItemListStart}{\begin{itemize}[leftmargin=*,labelsep=1mm,itemsep=\fpeval{0.8 * \baseSpace} pt]\fontText}
...
\begin{center}
	\fontHeaderInfo{
		...
		\href{https://kristoferfannar.com}{kristoferfannar.com} |
...
\resumeItemListStart
\item Built a Python service which automated exploit testing on >2.000 CVE vulnerabilities on >50.000 Bloomberg applications
\item Demonstrated exploitability on over 700 critical \& high vulnerabilites in Bloomberg environment
...
\resumeItemListStart
\item Wrote, bundled and signed security desktop driver for macOS from scratch in Rust, now adopted by 1/3rd of company's userbase
...
{Teaching Assistant}{Aug 2023 - May 2024} % | Algorithms $\cdot$ Web Programming $\cdot$ Computer Networks}
\resumeItemListStart
...
\resumeProject
{\href{https://github.com/lmkdatabase/lmkdb}{lmkDB - GPU accelerated database}}
{\href{https://github.com/lmkdatabase/lmkdb}{github.com/lmkdatabase \small{\faGithub}}}
\resumeItemListStart
