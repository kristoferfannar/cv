...
\resumeItemListStart
\vspace{1.0mm}
    \item Honors: Dean's list Fall 2023 \& Fall 2024 $\cdot$ Freshmman grant Fall 2021
    \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
...
\vspace{-0.4mm}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
\item Worked alongside team to design and develope a full-stack prototype for \href{https://bcp.online}{\emph{bcp.online}}, supporting multi-user multi-role organizations using playbooks, roles, trainings and incident handling
