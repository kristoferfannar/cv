...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
		...
		\item Implemented automatic app building, signing \& notarization pipelines for seamless distribution for macOS devices through GitHub Actions 
      \resumeItemListEnd 
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
	  \item Collaborated alongside team to design and develope a full-stack prototype for \href{https://bcp.online}{\emph{bcp.online}}, supporting multi-user multi-role functionality for organizational playbooks and incident handling
