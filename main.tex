...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
	    \item Expanded the Keystrike Desktop Client, used for creating cryptographic attestations for typed user input, to macOS from heavily windows coupled Rust codebase
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
\item Designed and created a working prototype for \href{https://bcp.online}{\emph{bcp.online}}, supporting 
...
\section{\textbf{Skills}}
 ...
 \resumeSubItem{Languages \& frameworks| }
    {Python, Javascript, Go, Rust, Java, C++, React, Nextjs, Echo, SQL}

	\resumeSubItem{DevOps \& Infra| }
    {AWS EC2, CI/CD, Apple Codesigning, Docker, Protobuf}

	\resumeSubItem{Interests}
	{Systems, Cybersecurity, Competitive Programming}
